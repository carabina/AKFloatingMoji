...
protocol AKFloatingMojiDelegate: NSObjectProtocol {
    /// Send a reply message with the given string.
    func send(reply: String) -> Void
}

class AKFloatingMojiViewController : UIViewController {
    weak var delegate: AKFloatingMojiDelegate?
    
    private let customTransitionDelegate = AKFloatingMojiTransitionDelegate()
    ...
    private let replyButtons: [AKFloatingMojiButton]
    private let dismissButton = AKFloatingMojiButton(title: "✖︎")
    ...
    private func replyButton(at point: CGPoint?) -> AKFloatingMojiButton? {
    ...
    init() {
        replyButtons = [AKFloatingMojiButton(title: "❤️"),
                        AKFloatingMojiButton(title: "😄"),
                        AKFloatingMojiButton(title: "👍"),
                        AKFloatingMojiButton(title: "😯"),
                        AKFloatingMojiButton(title: "😢"),
                        AKFloatingMojiButton(title: "😈")]
